...
This project presents a machine learning–based system for phishing URL detection using only URL-based features. The system classifies web links as legitimate or phishing and provides probability-based predictions in real time.
